...
public class YatzyTest {
    ...
    public void fours()
    {
        assertEquals(0, new Yatzy(1,2,3,2,5).fours());
    ...
    @Test
    public void fives() {
        assertEquals(0, new Yatzy(2,4,4,1,6).fives());
    ...
    public void twoPairs() {
        assertEquals(0, Yatzy.two_pair(1,2,5,4,3));
    ...
    {
        assertEquals(0, Yatzy.three_of_a_kind(3,3,2,4,5));
    ...
    public void fourOfAKind() {
        assertEquals(0, Yatzy.four_of_a_kind(2,3,3,3,5));
