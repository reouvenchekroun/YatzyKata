...
public class YatzyTest {
    ...
    {
        assertEquals(0, Yatzy.threeOfAKind(new DiceWrapper(3,3,2,4,5)));
        assertEquals(9, Yatzy.threeOfAKind(new DiceWrapper(3,3,3,4,5)));
        assertEquals(15, Yatzy.threeOfAKind(new DiceWrapper(5,3,5,4,5)));
        assertEquals(9, Yatzy.threeOfAKind(new DiceWrapper(3,3,3,3,5)));
    }

    @Test
    public void fourOfAKind() {
        assertEquals(0, Yatzy.fourOfAKind(new DiceWrapper(2,3,3,3,5)));
        assertEquals(12, Yatzy.fourOfAKind(new DiceWrapper(3,3,3,3,5)));
        assertEquals(20, Yatzy.fourOfAKind(new DiceWrapper(5,5,5,4,5)));
        assertEquals(12, Yatzy.fourOfAKind(new DiceWrapper(3,3,3,3,3)));
    }

    @Test
    public void smallStraight() {
        assertEquals(0, Yatzy.smallStraight(new DiceWrapper(1,2,2,4,5)));
        assertEquals(15, Yatzy.smallStraight(new DiceWrapper(1,2,3,4,5)));
        assertEquals(15, Yatzy.smallStraight(new DiceWrapper(2,3,4,5,1)));
    }

    @Test
    public void largeStraight() {
        assertEquals(0, Yatzy.largeStraight(new DiceWrapper(1,2,2,4,5)));
        assertEquals(20, Yatzy.largeStraight(new DiceWrapper(6,2,3,4,5)));
        assertEquals(20, Yatzy.largeStraight(new DiceWrapper(2,3,4,5,6)));
    }

    @Test
    public void fullHouse() {
        assertEquals(0, Yatzy.fullHouse((new DiceWrapper(2,3,4,5,6))));
        assertEquals(18, Yatzy.fullHouse((new DiceWrapper(6,2,2,2,6))));
        assertEquals(0, Yatzy.fullHouse((new DiceWrapper(1,1,2,2,6))));
        assertEquals(0, Yatzy.fullHouse((new DiceWrapper(1,1,1,1,6))));
    }
}